...
public class PeonValidator extends PieceMovementComponent {
    public PeonValidator(int xInicial, int yInicial, int xFinal, int yFinal, Casilla[][] casillas, Cliente cliente) {
