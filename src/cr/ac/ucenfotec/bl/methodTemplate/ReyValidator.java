...
public class ReyValidator extends PieceMovementComponent {
    public ReyValidator(int xInicial, int yInicial, int xFinal, int yFinal, Casilla[][] casillas, Cliente cliente) {
